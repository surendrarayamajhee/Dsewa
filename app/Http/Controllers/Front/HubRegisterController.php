...
class HubRegisterController extends Controller
{

    public function getState()
    {

        $addresses = Address::where('type', 'STATE_NO')->get();
    ...
    public function getDistrict($id)
    {
        ...
        $addresses = Address::where('parent_id', $id)->get();
        return response()->json($addresses);
    }
    ...
    public function updateProfile(Request $request)
    {
        ...
        $userInfo->job_title = $request->jobtitle;
        $userInfo->citizenship_no = $request->citizenshipno;
        $userInfo->image = $request->profileimage;
        $success = $userInfo->update();
        if ($success) {
            return response()->json([
                'status' => 'success',
