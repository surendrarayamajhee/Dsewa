    ...
    <div id="main-wrapper">
        ...
        <img src="images/D-sewa.png" style="width:243px; height:80px">
            <!-- <div class="brand-logo">
                <a href="index.html"> 
                    ...
                    <b class="logo-abbr"> </b> 
                    <span class="logo"><img src="./images/d-sewa .png" alt=""> d-Sewa </span>
        ...
        ***********************************-->
        ...
        <div class="nk-sidebar" style=""> 
            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width:auto; height: 3388.330px;">
            <div class="nk-nav-scroll active" style=" font-size: smaller; overflow: hidden; width:auto; height: 3388.330px;">          
            <div class="nk-nav-scroll" style="width:auto; height: 3388.330px">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-globe-alt menu-icon"></i><span class="nav-text">Accounts</span>
                        </a>
                        <ul aria-expanded="false">
                    ...
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-globe-alt menu-icon"></i><span class="nav-text">vendor</span>
                        </a>
                        <ul aria-expanded="false">
                        <li><router-link :to="{ name: 'profile' }">profile details</router-link></li>
                        <li><router-link :to="{ name: 'productType' }">product type</router-link></li>
                        <li><router-link :to="{ name: 'ChangePassword' }">Change password</router-link></li>
                        <li><router-link :to="{ name: 'Address' }">My Address</router-link></li>
        ...
        ***********************************-->
        <!-- <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; Designed dSewa & Developed by <a href="">Suren</a> 2019</p>
            </div>
        </div> -->
        <!--**********************************
            Footer end
